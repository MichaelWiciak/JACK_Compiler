...
int isJackLibraryMathMethod(char* name) {
    if (strcmp(name, "abs") == 0) {
        // generate code for vm file
        temporaryVariable = "call Math.abs 1\n";
        return 1;
    } else if (strcmp(name, "multiply") == 0) {
        // generate code for vm file
        temporaryVariable = "call Math.multiply 2\n";
        return 1;
    } else if (strcmp(name, "divide") == 0) {
        // generate code for vm file
        temporaryVariable = "call Math.divide 2\n";
        return 1;
    } else if (strcmp(name, "min") == 0) {
        // generate code for vm file
        temporaryVariable = "call Math.min 2\n";
        return 1;
    } else if (strcmp(name, "max") == 0) {
        // generate code for vm file
        temporaryVariable = "call Math.max 2\n";
        return 1;
    } else if (strcmp(name, "sqrt") == 0) {
        // generate code for vm file
        temporaryVariable = "call Math.sqrt 1\n";
        return 1;
    } else {
        return 0;
    }
...
int isJackLibraryMemoryMethod(char* name) {
    if (strcmp(name, "peek") == 0) {
        // generate code for vm file
        temporaryVariable = "call Memory.peek 1\n";
        return 1;
    } else if (strcmp(name, "poke") == 0) {
        // generate code for vm file
        temporaryVariable = "call Memory.poke 2\n";
        return 1;
    } else if (strcmp(name, "alloc") == 0) {
        // generate code for vm file
        temporaryVariable = "call Memory.alloc 1\n";
        return 1;
    } else if (strcmp(name, "deAlloc") == 0) {
        // generate code for vm file
        temporaryVariable = "call Memory.deAlloc 1\n";
        return 1;
    } else {
        return 0;
    }
...
int isJackLibraryOutputMethod(char* name) {
    if (strcmp(name, "moveCursor") == 0) {
        // generate code for vm file
        temporaryVariable = "call Output.moveCursor 2\n";
        return 1;
    } else if (strcmp(name, "printChar") == 0) {
        // generate code for vm file
        temporaryVariable = "call Output.printChar 1\n";
        return 1;
    } else if (strcmp(name, "printInt") == 0) {
        // generate code for vm file
        temporaryVariable = "call Output.printInt 1\n";
        return 1;
    } else if (strcmp(name, "printString") == 0) {
        // generate code for vm file
        temporaryVariable = "call Output.printString 1\n";
        return 1;
    } else if (strcmp(name, "println") == 0) {
        // generate code for vm file
        temporaryVariable = "call Output.println 0\n";
        return 1;
    } else if (strcmp(name, "backSpace") == 0) {
        // generate code for vm file
        temporaryVariable = "call Output.backSpace 0\n";
        return 1;
    } else {
        return 0;
    }
...
int isJackLibraryScreenMethod(char* name) {
    if (strcmp(name, "clearScreen") == 0) {
        // generate code for vm file
        temporaryVariable = "call Screen.clearScreen 0\n";
        return 1;
    } else if (strcmp(name, "setColor") == 0) {
        // generate code for vm file
        temporaryVariable = "call Screen.setColor 1\n";
        return 1;
    } else if (strcmp(name, "drawPixel") == 0) {
        // generate code for vm file
        temporaryVariable = "call Screen.drawPixel 2\n";
        return 1;
    } else if (strcmp(name, "drawLine") == 0) {
        // generate code for vm file
        temporaryVariable = "call Screen.drawLine 4\n";
        return 1;
    } else if (strcmp(name, "drawRectangle") == 0) {
        // generate code for vm file
        temporaryVariable = "call Screen.drawRectangle 4\n";
        return 1;
    } else if (strcmp(name, "drawCircle") == 0) {
        // generate code for vm file
        temporaryVariable = "call Screen.drawCircle 3\n";
        return 1;
    } else {
        return 0;
    }
...
int isJackLibraryStringMethod(char* name) {
    if (strcmp(name, "new") == 0) {
        // generate code for vm file
        temporaryVariable = "call String.new 1\n";
        return 1;
    } else if (strcmp(name, "dispose") == 0) {
        // generate code for vm file
        temporaryVariable = "call String.dispose 1\n";
        return 1;
    } else if (strcmp(name, "length") == 0) {
        // generate code for vm file
        temporaryVariable = "call String.length 1\n";
        return 1;
    } else if (strcmp(name, "charAt") == 0) {
        // generate code for vm file
        temporaryVariable = "call String.charAt 2\n";
        return 1;
    } else if (strcmp(name, "setCharAt") == 0) {
        // generate code for vm file
        temporaryVariable = "call String.setCharAt 3\n";
        return 1;
    } else if (strcmp(name, "appendChar") == 0) {
        // generate code for vm file
        temporaryVariable = "call String.appendChar 2\n";
        return 1;
    } else if (strcmp(name, "setInt") == 0) {
        // generate code for vm file
        temporaryVariable = "call String.setInt 3\n";
        return 1;
    } else if (strcmp(name, "eraseLastChar") == 0) {
        // generate code for vm file
        temporaryVariable = "call String.eraseLastChar 1\n";
        return 1;
    } else if (strcmp(name, "intValue") == 0) {
        // generate code for vm file
        temporaryVariable = "call String.intValue 1\n";
        return 1;
    } else if (strcmp(name, "backSpace") == 0) {
        // generate code for vm file
        temporaryVariable = "call String.backSpace 0\n";
        return 1;
    } else if (strcmp(name, "doubleQuote") == 0) {
        // generate code for vm file
        temporaryVariable = "call String.doubleQuote 0\n";
        return 1;
    } else if (strcmp(name, "newLine") == 0) {
        // generate code for vm file
        temporaryVariable = "call String.newLine 0\n";
        return 1;
    } else {
        return 0;
    }
...
int isJackLibrarySysMethod(char* name) {
    if (strcmp(name, "halt") == 0) {
        // generate code for vm file
        temporaryVariable = "call Sys.halt 0\n";
        return 1;
    } else if (strcmp(name, "error") == 0) {
        // generate code for vm file
        temporaryVariable = "call Sys.error 0\n";
        return 1;
    } else if (strcmp(name, "wait") == 0) {
        // generate code for vm file
        temporaryVariable = "call Sys.wait 1\n";
        return 1;
    } else {
        return 0;
    }
...
int isJackLibraryKeyboardMethod(char* name) {
    if (strcmp(name, "keyPressed") == 0) {
        // generate code for vm file
        temporaryVariable = "call Keyboard.keyPressed 1\n";
        return 1;
    } else if (strcmp(name, "readChar") == 0) {
        // generate code for vm file
        temporaryVariable = "call Keyboard.readChar 0\n";
        return 1;
    } else if (strcmp(name, "readLine") == 0) {
        // generate code for vm file
        temporaryVariable = "call Keyboard.readLine 0\n";
        return 1;
    } else if (strcmp(name, "readInt") == 0) {
        // generate code for vm file
        temporaryVariable = "call Keyboard.readInt 0\n";
        return 1;
    } else {
        return 0;
    }
...
int isJackLibraryArrayMethod(char* name) {
    if (strcmp(name, "new") == 0) {
        // generate code for vm file
        temporaryVariable = "call Array.new 1\n";
        return 1;
    } else if (strcmp(name, "dispose") == 0) {
        // generate code for vm file
        temporaryVariable = "call Array.dispose 1\n";
        return 1;
    } else {
        return 0;
    }
...
// calculate the number of local variables in a symbol table
int calculateNumberOfLocalVariablesInCurrentScope(SymbolTable* symbolTable) {
    int numOfLocals = 0;
    for (int i = 0; i < symbolTable->nextAvailableLocation; i++) {
        if (symbolTable->table[i]->kind == var) {
            numOfLocals++;
        }
    }
    return numOfLocals;
...
// calculate the number of field variables in a symbol table
int calculateNumberOfFieldVariablesInCurrentScope(SymbolTable* symbolTable) {
    int numOfFields = 0;
    for (int i = 0; i < symbolTable->nextAvailableLocation; i++) {
        if (symbolTable->table[i]->kind == fieldVariable) {
            numOfFields++;
        }
    }
    return numOfFields;
